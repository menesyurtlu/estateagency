...
class ApiResponses extends ResourceCollection
{
    // [Informational 1xx]
    ...
    const REQUEST_VALIDATION_ERROR = 422;
    ...
    private static $messages = array(
        ...
        422 => '422 One or more validation errors found.',
     ...
     * @return object
     */
    public static function send(int $code = 200, $body)
    {
        return (object)[
            "status" => !self::isError($code),
            "code" => $code,
